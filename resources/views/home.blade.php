...
<section class="hero">
    <div class="hero__slider owl-carousel">
        <div class="hero__items set-bg" data-setbg="img/hero/hero-new.png">
            <div class="container">
                <div class="row">
            ...
            <div class="col-lg-7 offset-lg-4">
                <div class="banner__item">
                    <div class="banner__item__pic">
                        <img src="img/banner/banner-1.webp" alt="" />
                    </div>
                    <div class="banner__item__text">
                        <h2>Clothing Collections 2030</h2>
                        <a href="{{ route('shop.categoryfilter', $shirts) }}">Shop now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="banner__item banner__item--middle">
                    <div class="banner__item__pic">
                        <img src="img/banner/banner-2.webp" alt="" />
                    </div>
                    <div class="banner__item__text">
                        <h2>Accessories</h2>
                        <a href="{{ route('shop.categoryfilter', $accessories) }}">Shop now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="banner__item banner__item--last">
                    <div class="banner__item__pic">
                        <img src="img/banner/banner-3.webp" alt="" />
                    </div>
                    <div class="banner__item__text">
                        <h2>Shoes Spring 2030</h2>
                        <a href="{{ route('shop.categoryfilter', $shoes) }}">Shop now</a>
                    </div>
                </div>
            </div>
        </div>
