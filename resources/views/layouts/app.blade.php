...
<head>
    ...
    <title>{{ $title }} </title>
    <link rel="icon" type="image/x-icon" href="{{ asset('img/favicon-sml.png') }}">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="/"><img src="{{asset('img/logo fstyle.png')}}" alt="" /></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{ asset('img/logo_fstyle-tr.png') }}" alt="" /></a>
                        </div>
                        <p>
